...
public class SignatureManager {
    ...
    private Sign getSignByCallerID(String callerID) {
        ...
        return SecureUtil.sign(keyPairProps.getAlgorithm(), keyPairProps.getPriKey(), keyPairProps.getPubKey());
    }
    ...
    private void loadKeyPairByPath() {
        ...
        signatureProps.getKeyPair()
                .forEach((key, keyPairProps) -> {
                    ...
                    keyPairProps.setPubKey(loadKeyByPath(keyPairProps.getPubKeyPath()));
                    keyPairProps.setPriKey(loadKeyByPath(keyPairProps.getPriKeyPath()));
                    if (ObjectUtils.isEmpty(keyPairProps.getPubKey()) ||
                            ObjectUtils.isEmpty(keyPairProps.getPriKey())) {
