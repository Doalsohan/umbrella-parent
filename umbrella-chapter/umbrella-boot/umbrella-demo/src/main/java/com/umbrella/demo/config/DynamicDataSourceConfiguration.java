...
public class DynamicDataSourceConfiguration {
    ...
    public DynamicRoutingDataSource DataSource(@Qualifier("masterDataSource") DataSource masterDataSource,
        ...
        targetDataSource.put(DataSourceType.MASTER_DATASOURCE.getName(), masterDataSource);
        targetDataSource.put(DataSourceType.SLAVE_DATASOURCE.getName(), slaveDataSource);
